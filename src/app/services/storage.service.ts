...
export class StorageService {
  ...
  public getMetadataFromStorage(): InventoryMetadata | undefined {
    ...
    try {
      ...
      this.logger.errorWithError("LocalStorageService", "Error during parsing inventory metadata from local storage", e);
      return undefined;
    }
  }

  public persistMetadata(metadata: InventoryMetadata): void {
    this.logger.debug("LocalStorageService", "Saving inventory metadata in local storage")
  ...
  public getSpecimensFromStorage(): Specimen[] | undefined {
    ...
    try {
      ...
      this.logger.errorWithError("LocalStorageService", "Error during parsing specimens from local storage", e);
      return undefined;
    }
  }

  public persistSpecimens(specimens: Specimen[]): void {
    this.logger.debug("LocalStorageService", "Saving inventory specimens in local storage")
